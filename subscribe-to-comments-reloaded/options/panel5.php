...
if (isset($_POST['options'])){
	...
	if (isset($_POST['options']['htmlify_message_links']) && !subscribe_reloaded_update_option('htmlify_message_links', $_POST['options']['htmlify_message_links'], 'yesno')) $faulty_fields = __('HTMLify Links in HTML emails','subscribe-reloaded').', ';
	...
	if (isset($_POST['options']['admin_bcc']) && !subscribe_reloaded_update_option('admin_bcc', $_POST['options']['admin_bcc'], 'yesno')) $faulty_fields = __('BCC admin on Notifications','subscribe-reloaded').', ';
...
<table class="form-table <?php echo $wp_locale->text_direction ?>">
	...
	<tr>
		...
		<td>
			...
			<div class="description"><?php _e('If enabled, will wrap all links in messages with <code>&lt;a href=""&gt;&lt;/a&gt;</code> (only when HTML emails enabled).','subscribe-reloaded'); ?></div></td>
	</tr>
	<tr>
	...
	<tr>
		<th scope="row"><label for="admin_bcc"><?php _e('BCC admin on Notifications','subscribe-reloaded') ?></label></th>
		<td>
			...
			<div class="description"><?php _e('Send a copy of all Notifications to the administrator.','subscribe-reloaded'); ?></div></td>
	</tr>
</tbody>
</table>
